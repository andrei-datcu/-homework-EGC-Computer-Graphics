		...
		{	
			...
			if (!objects3D[i]->fill)
			{
				...
				for (vertex = 0; vertex < objects3D[i]->faces[face]->contour.size(); vertex++)
				{
					...
					glVertex3f(objects3D[i]->transf_vertices[objects3D[i]->faces[face]->contour[vertex]]->x,
							   objects3D[i]->transf_vertices[objects3D[i]->faces[face]->contour[vertex]]->y,
							   objects3D[i]->transf_vertices[objects3D[i]->faces[face]->contour[vertex]]->z);
				}
				glEnd();
			}
			else
